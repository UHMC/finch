...
${OBJECTDIR}/SampleMain.o: SampleMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SampleMain.o SampleMain.cpp

${OBJECTDIR}/CommandLineFinch.o: CommandLineFinch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CommandLineFinch.o CommandLineFinch.cpp

${OBJECTDIR}/Finch/Finch.o: Finch/Finch.cpp 
	${MKDIR} -p ${OBJECTDIR}/Finch
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Finch/Finch.o Finch/Finch.cpp

${OBJECTDIR}/Finch/hid-libusb.o: Finch/hid-libusb.c 
	${MKDIR} -p ${OBJECTDIR}/Finch
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Finch/hid-libusb.o Finch/hid-libusb.c
